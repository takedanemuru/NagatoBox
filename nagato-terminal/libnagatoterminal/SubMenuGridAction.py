...
from libnagatoterminal.GridData import NagatoGridData

MESSAGE = "YUKI.N > menu clicked"


class NagatoSubMenuGridAction(Gtk.Menu, NagatoObject):
    ...
    def _add_child_menu_item(self, title, gtk_position_type):
        NagatoMenuItem(self, title, MESSAGE, gtk_position_type)
